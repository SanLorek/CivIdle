export const PT_BR = {
   ...
   GoldenPavilionDesc: "Todos os edifícios dentro do alcance de 3 blocos ganham +1 Multiplicador de Produção para cada edifício adjacente que produz qualquer um dos seus recursos consumidos (excluindo Laboratório de Clones e Fábrica de Clones e o edifício não pode ser desligado).",
   ...
   PermanentGreatPeopleLevels: "Níveis das Figuras Históricas Permanentes",
   ...
   ProductionPriorityDescV2: "Prioridade mais alta significa que este edifício transporta antes de outros edifícios. Número maior significa prioridade mais alta.",
   ...
   ReligionChristianity: "Cristandade",
   ...
   ShenandoahDescV2: "Edifícios desbloqueados na era atual recebem +2 de Multiplicador de Produção. Dobla o efeito de J.P. Morgan.",
   Shortcut: "Atalhos",
   ...
   SocialismLevel4DescHTMLV2: "Gerar ciência única equivalente ao custo da tecnologia mais barata da <b>Era das Guerras Mundiais</b>",
   SocialismLevel5DescHTMLV2: "Gerar ciência única equivalente ao custo da tecnologia mais barata da <b>Era da Guerra Fria</b>",
   ...
   StatisticsBuildingsFilters: "Filtros",
   ...
   StatisticsResourcesFilters: "Filtros",
   ...
   TheMet: "The Met",
   TheMetDesc: "Após construído, gera teleportes que podem ser usados ​​para mover edifícios. Todos os edifícios dentro do alcance de 2 blocos recebem +1 de Produção, Capacidade de Trabalhadores e Multiplicador de Armazenamento",
